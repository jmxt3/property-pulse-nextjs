...
const HomeProperties = () => {
    ...
    return (
        <>
            ...
            <section className="m-auto max-w-lg mb-10 mt-5 px-6">
                <Link href="/properties" className="block bg-black text-white text-center font-bold py-4 px-6 rounded-xl hover:bg-gray-700">
                    View All Properties
                </Link>
